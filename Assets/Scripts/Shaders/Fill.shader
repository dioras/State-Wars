Shader "Unlit/SpecialFX/Liquid"
{
    Properties
    {
        ...
        _FillAmount("Fill Amount", Range(-18,18)) = 0.0
        ...
        SubShader
        {
            ...
            v2f vert(appdata v)
            {
               ...
               o.fillEdge = (_flip == true ? -worldPosAdjusted.x : worldPosAdjusted.x) - + _FillAmount;
